...
export default function BiRefisPercentuaisPage() {
  ...
  useEffect(() => {
    ...
    const fetchToken = async () => {
      try {
        const response = await fetch('/api/metabase/token?dashboard=8')
        if (!response.ok) {
    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(139, 69, 172, 0.3) 0%, transparent 70%)',
            top: '-10%',
            left: '-5%',
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <AppHeader
          ...
          biTitle="Painel BI REFIS - Percentuais de Entrada"
